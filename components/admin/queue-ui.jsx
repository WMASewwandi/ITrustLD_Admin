  ...
  return (
    <div className="flex items-start gap-1.5">
      ...
      <button
        type="button"
        onClick={copy}
        className="mt-0.5 shrink-0 rounded p-0.5 text-slate-300 transition hover:bg-slate-100 hover:text-admin-teal"
        title="Copy"
      >
...
export const inputCls =
  "w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-admin-teal/50 focus:ring-2 focus:ring-admin-teal/15";
