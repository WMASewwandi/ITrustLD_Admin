...
export default function RolesPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setRoles((prev) =>
        prev.map((r) => (r.name === editRole ? res.role : r))
      );
      setEditRole(null);
    } catch (err) {
  ...
  return (
    <div>
      ...
      {editing ? (
        <div className="admin-modal-overlay" onClick={() => !saving && setEditRole(null)}>
          <div
            ...
            <div className="flex items-start justify-between border-b border-white/10 px-5 py-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">
                  {editing.display_name} · <span className="font-mono text-xs">{editing.name}</span>
                </p>
              </div>
              <button
                type="button"
                    ...
                    <div className="space-y-2">
                      {category.activities?.map((activity) => (
                        ...
                        >
                          ...
                          <input
                            type="checkbox"
                            checked={draftPermissions.includes(activity.identifier)}
                            onChange={() => togglePermission(activity.identifier)}
