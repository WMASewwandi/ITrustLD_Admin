...
function BannerPreview({ label, previewUrl }) {
  return (
    <div className="overflow-hidden rounded-xl border border-white/10 bg-white/5">
      <p className="border-b border-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-slate-400">
        Banner Preview
      </p>
      {previewUrl ? (
...
export default function UpdateBlogPage() {
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-2xl font-bold tracking-tight text-white">Update Blog Post</h1>
