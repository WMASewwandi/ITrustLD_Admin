...
export async function fetchLoyaltyManagementConfigs(audience = 'standard', tier = 'all') {
...
export async function createPointCollection({ calAmount, isAffiliate, membershipTier }) {
  return apiRequest(
    ...
    withToken({
      ...
      body: {
        ...
        pointcollection_membership_tier: membershipTier,
      },
    }),
  );
}

export async function updatePointCollectionAmount({ id, calAmount, membershipTier }) {
  return apiRequest(
...
export async function createBonus({ bonusAmount, isAffiliate, membershipTier }) {
  return apiRequest(
    ...
    withToken({
      ...
      body: {
        ...
        bonus_membership_tier: membershipTier,
      },
    }),
  );
}

export async function updateBonusAmount({ id, bonusAmount, membershipTier }) {
  return apiRequest(
