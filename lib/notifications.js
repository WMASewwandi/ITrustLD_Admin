...
export const ADMIN_NAV_COUNTS_REVISION_EVENT = 'admin-nav-counts-revision';
...
export function notifyAdminNavCountsRevision(revision) {
  if (typeof window !== 'undefined') {
    window.dispatchEvent(new CustomEvent(ADMIN_NAV_COUNTS_REVISION_EVENT, { detail: { revision } }));
  }
}
