...
/**
 * Immediate post-login URL: first TOP_NAV item the user is allowed to open.
 */
export function resolvePostLoginHref(roles = [], permissions = [], nav = []) {
  return (
    getFirstAllowedNavHref(nav, permissions) ||
