...
/** Logo / breadcrumb home: dashboard when permitted, otherwise the ops landing page. */
export function resolveAdminHomeHref(permissions = []) {
  if (hasPermission(permissions, "view_admin_dashboard")) {
...
/**
 * Immediate post-login URL: Dashboard when allowed, otherwise the ops home page.
 */
export function resolvePostLoginHref(roles = [], permissions = [], _nav = []) {
  return resolveAdminHomeHref(permissions);
}
