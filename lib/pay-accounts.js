...
export async function togglePayAccountCategoryStatus(categoryId, active) {
  return apiRequest(`/admin/pay-accounts/categories/${categoryId}/toggle-status`, {
    ...withToken({ method: 'POST' }),
    body: { active },
  });
}

export async function toggleBuiltinPayAccountCategoryStatus(accountType, active) {
  return apiRequest(`/admin/pay-accounts/builtin/${accountType}/toggle-status`, {
    ...withToken({ method: 'POST' }),
    body: { active },
  });
}

export async function renameBuiltinPayAccount(accountType, payload) {
  return apiRequest(`/admin/pay-accounts/builtin/${accountType}/rename`, {
    ...withToken({ method: 'POST' }),
    body: payload,
  });
}
...
export async function createBuiltinPayAccountField(accountType, payload) {
  return apiRequest(`/admin/pay-accounts/builtin/${accountType}/fields`, {
    ...withToken({ method: 'POST' }),
    body: payload,
  });
}
...
export async function updateBuiltinPayAccountField(fieldId, payload) {
  return apiRequest(`/admin/pay-accounts/builtin-fields/${fieldId}/update`, {
    ...withToken({ method: 'POST' }),
    body: payload,
  });
}
...
export async function deleteBuiltinPayAccountField(fieldId) {
  return apiRequest(`/admin/pay-accounts/builtin-fields/${fieldId}/delete`, {
    ...withToken({ method: 'POST' }),
  });
}
